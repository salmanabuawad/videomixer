          ...
          <ul>
            {assets.map((a) => {
              ...
              const sourceLabel: Record<string, string> = {
                runway: "generated by Runway",
                ffmpeg_stub: "placeholder",
                heygen: "HeyGen presenter",
                heygen_stub: "HeyGen placeholder",
              };
              const tag = sourceLabel[a.source];
              return (
      ...
      <div className="card">
        ...
        {knowledge ? (
          <>
            ...
            {knowledge.narration_text && (
              <>
                <p>
                  <strong>Narration:</strong>
                </p>
                <p style={{ whiteSpace: "pre-wrap" }}>{knowledge.narration_text}</p>
              </>
            )}
            {(knowledge.intro_script || knowledge.closing_script) && (
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 8 }}>
                {knowledge.intro_script && (
                  <div>
                    <p style={{ margin: "0 0 4px" }}>
                      <strong>Intro presenter script</strong>
                    </p>
                    <p style={{ whiteSpace: "pre-wrap", margin: 0 }}>{knowledge.intro_script}</p>
                  </div>
                )}
                {knowledge.closing_script && (
                  <div>
                    <p style={{ margin: "0 0 4px" }}>
                      <strong>Closing presenter script</strong>
                    </p>
                    <p style={{ whiteSpace: "pre-wrap", margin: 0 }}>{knowledge.closing_script}</p>
                  </div>
                )}
              </div>
            )}
